...
--
-- Host: localhost:3306
-- Generation Time: Jul 15, 2022 at 05:03 PM
...
--
-- Table structure for table `data_buletin`
--

CREATE TABLE `data_buletin` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `data_buletin`
--

INSERT INTO `data_buletin` (`id`, `judul`, `bulan`, `tahun`, `status`, `create_by`, `update_by`, `create_date`, `update_date`) VALUES
(13, 'sadas', '2', '2022', '0', '1', '1', '2022-07-15 16:51:03', '2022-07-15 16:51:03');
...
(68, 3, 'icon', './assets/upload/icon/2022/06/06', '6036', 'image/jpeg', 'noavatar.jpg', '', '2022-06-06 14:52:39', '2022-06-06 14:52:39'),
...
(69, 15, 'poster', './assets/upload/galeri/poster/2022/07/15', '30562', 'image/png', '1_Sy7T_GQKofS-vWgUTZCLVw.png', NULL, '2022-07-15 16:34:45', '2022-07-15 16:34:45'),
...
(70, 15, 'poster', './assets/upload/galeri/poster/2022/07/15', '180687', 'application/pdf', 'dummy.pdf', NULL, '2022-07-15 16:34:45', '2022-07-15 16:34:45'),
(75, 13, 'buletin', './assets/upload/galeri/buletin/2022/07/15', '30562', 'image/png', '1_Sy7T_GQKofS-vWgUTZCLVw.png', NULL, '2022-07-15 16:51:03', '2022-07-15 16:51:03'),
(76, 13, 'buletin', './assets/upload/galeri/buletin/2022/07/15', '180687', 'application/pdf', 'dummy.pdf', NULL, '2022-07-15 16:51:03', '2022-07-15 16:51:03');
...
--
-- Dumping data for table `data_icon`
--

INSERT INTO `data_icon` (`id`, `nama`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
(3, 'TESTing', 1, 1, '2022-06-06 14:52:39', NULL, NULL);
...
(2, 'juduljasASFAG', 'testgfhgffgjgjfg', '2022', 1, 1, '1', '2022-04-03 08:23:34', '1', '2022-05-18 08:48:21');
...
(15, 'jduul', '2', '2022', '0', '1', '1', '2022-07-15 16:34:45', '2022-07-15 16:34:45');
...
--
-- Indexes for table `data_buletin`
--
ALTER TABLE `data_buletin`
  ADD PRIMARY KEY (`id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `data_buletin`
--
ALTER TABLE `data_buletin`

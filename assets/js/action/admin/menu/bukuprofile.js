$(function () {
  ...
  $('#add-berita').on('click', function(){
    ...
    loadkat();
    $('#id').val('');
    $('.modal-title').html('<i class="fas fa-newspaper"></i> Tambah Buku Profil');
    ...
    function savedata(st){
      ...
      default:
        ...
        if(id){
          ...
          var baseurl = 'updatedatabuku';
          var msg = 'Update Buku Profil';

        }else{
          var baseurl = 'savedatabuku';
          var msg = 'Tambah Buku Profil';
        }
...
function deleteData(id, id_file1, path1, id_file2, path2){
  ...
  swalWithBootstrapButtons.fire({
    title: 'Anda yakin, hapus Buku Profil ini?',
    text: "",
    icon: 'warning',
...
function cekusername(uname){
    ...
    function editdong(id, judul, intro, tahun, kategori,status, path1, path2, idfile1, idfile2, filename1, filename2){
      ...
      $('.modal-title').html('<i class="fas fa-images"></i> Edit Buku Profil');
      $('#id').val(id);
      $('#idfile1').val(idfile1);
      $('#idfile2').val(idfile2);
      $('#lbl1').html(filename1);
    ...
    function editkat(id,nama){
      Swal.fire({
        ...
        fdata.append('table','kategori_profile');
        updatekat(fdata);
      })
    }
    ...
    function savekategori()
    {
      ...
      fd.append('table','kategori_profile');
